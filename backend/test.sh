...
# echo "POST invoke chaincode on peers of Org1 and Org2 - initLedger"
# echo
# VALUES=$(curl -s -X POST \
#   http://localhost:4000/channels/mychannel/chaincodes/cert \
#   -H "authorization: Bearer $ORG1_TOKEN" \
#   -H "content-type: application/json" \
#   -d "{
...
# echo "POST invoke chaincode on peers of Org1 and Org2 - createCert"
# echo
# VALUES=$(curl -s -X POST \
#   http://localhost:4000/channels/mychannel/chaincodes/cert \
#   -H "authorization: Bearer $ORG1_TOKEN" \
...
# echo
# curl -s -X GET \
#   "http://localhost:4000/channels/mychannel/chaincodes/cert?peer=peer0.org1.example.com&fcn=queryCert&args=CERT0" \
#   -H "authorization: Bearer $ORG1_TOKEN" \
#   -H "content-type: application/json"
# echo
# echo